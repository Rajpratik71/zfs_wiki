...
Unpacking zfs (from zfs_0.5.0-2_x86_64.deb) ...
Selecting previously deselected package zfs-devel.
Unpacking zfs-devel (from zfs-devel_0.5.0-2_x86_64.deb) ...
Selecting previously deselected package zfs-modules.
Unpacking zfs-modules (from zfs-modules_0.5.0-2_x86_64.deb) ...
Selecting previously deselected package zfs-modules-devel.
Unpacking zfs-modules-devel (from zfs-modules-devel_0.5.0-2_x86_64.deb) ...
Selecting previously deselected package zfs-test.
Unpacking zfs-test (from zfs-test_0.5.0-2_x86_64.deb) ...
