...
The result of this will be two source rpm packages.  Source rpms for RHEL6 also available from the "download":http://github.com/behlendorf/zfs/downloads section if you prefer.
...
* _zfs-devel-w.x.y-z.arch.rpm_: The zfs development headers.
* _zfs-test-w.x.y-z.arch.rpm_: The zfs regression test scripts and infrastructure.
* _zfs-modules-w.x.y-z_kernel.arch.rpm_: The zfs kernel module stack for your kernel version.
* _zfs-modules-devel-w.x.y-z_kernel.arch.rpm: The zfs development headers and symbols for building dependent kernel modules.
